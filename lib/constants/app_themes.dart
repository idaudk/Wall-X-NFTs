...
class AppThemes {
  ...
  static const Color nevada = Color.fromARGB(255, 47, 87, 189);
  static const Color ebonyClay = Color.fromARGB(255, 0, 0, 0);

  static String font1 = "Dsignes";
  static String font2 = "Dsignes";

  //defualt transition
  static const defaultTranstion = Transition.cupertino;
